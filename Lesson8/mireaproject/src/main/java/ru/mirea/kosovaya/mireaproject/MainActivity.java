package ru.mirea.kosovaya.mireaproject;
...
import ru.mirea.kosovaya.mireaproject.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ru.mirea.kosovaya.mireaproject.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
        ...
        marker.setPosition(new GeoPoint(55.761112, 37.618250));
        ...
        marker2.setPosition(new GeoPoint(55.83294,37.618525));
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Москвариум\nпр-т Мира, 119 строение 23, Москва",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker3.setPosition(new GeoPoint(55.749511, 37.63252));
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Парящий мост,Москворецкая наб., Москва",

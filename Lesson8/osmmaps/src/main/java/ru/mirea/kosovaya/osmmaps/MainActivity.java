package ru.mirea.kosovaya.osmmaps;
...
import ru.mirea.kosovaya.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ru.mirea.kosovaya.osmmaps.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(getLayoutInflater());
        ...
        marker.setPosition(new GeoPoint(55.749511, 37.63252));
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Парящий мост,Москворецкая наб.\n Москва",
        ...
        marker2.setPosition(new GeoPoint(55.761112, 37.618250));

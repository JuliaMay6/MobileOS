package ru.mirea.kosovaya.yandexdriver;
...
import ru.mirea.kosovaya.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener
{
    private ActivityMainBinding binding;
    private final String MAPKIT_API_KEY = "3836296e-3ca8-40f0-9847-b31b971c0a33";
    private final Point ROUTE_START_LOCATION = new Point(55.720089,37.902931);
    private final Point ROUTE_END_LOCATION = new Point(55.766142, 37.640138);
...
// Ининциализируем объект для создания маршрута водителя
        ...
        marker.addTapListener(new MapObjectTapListener() {
            ...
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                ...
                builder.setMessage("Изуми\nРесторан караоке-клуб бар,паб\nМясницкая улица, 38с1\n+7 (495) 621-55-10");
